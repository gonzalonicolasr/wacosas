...
export function lineasCandado(e: EstadoCandado, yaHay: boolean): Array<[string, Tono]> {
  ...
  return [
    ...
    ["", "tenue"],
    ["Usá los MISMOS dígitos que ya usás en WhatsApp. wacosas NO los", "tenue"],
    ["verifica contra WhatsApp (no puede): los guarda hasheados en tu", "tenue"],
    ["disco y compara contra eso.", "tenue"],
    ["", "tenue"],
    [`código: ${puntos}`, "campo"],
    ["", "tenue"],
    ...error,
